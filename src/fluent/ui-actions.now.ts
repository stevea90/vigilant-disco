...
UiAction({
    ...
    try {
        ...
        gs.addErrorMessage('AI Uplift error: ' + e.message);
    }
...
UiAction({
    ...
    try {
        ...
        gs.addErrorMessage('AI Generate Code error: ' + e.message);
    }
    action.setRedirectURL('rm_story.do?sys_id=' + current.getUniqueValue());
})();`,
})
...
UiAction({
    ...
    try {
        ...
        gs.addErrorMessage('AI Test Steps error: ' + e.message);
    }
    action.setRedirectURL('rm_story.do?sys_id=' + current.getUniqueValue());
})();`,
})
